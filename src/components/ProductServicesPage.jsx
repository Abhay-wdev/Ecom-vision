    ...
    <div className="relative min-h-screen overflow-hidden pt-8 pb-8">
      ...
      <div className="relative mx-auto px-4 sm:px-6 lg:px-8 max-w-[1200px]">
        ...
        <div className="text-center mb-6 sm:mb-10">
          ...
          >
            From digital marketing to complete e-commerce management, 
            we provide end-to-end solutions that help your brand grow online. 
          </motion.p>
        </div>
...
>
  ...
  <div className="relative z-10 mb-20">
    ...
    <p className="text-purple-800 text-base sm:text-lg font-semibold">
      Optimize your website for higher rankings and organic traffic.
    </p>
  </div>
  ...
  <div className="absolute bottom-0 left-0 w-full flex justify-center z-10">
    <img
      src="/images/Ecom/google-img.png"
          ...
          >
            ...
            <div className="relative z-10 mb-16">
              ...
              <p className="text-gray-700 text-base sm:text-lg font-semibold">
                Engage your audience and grow your brand across social platforms.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 mb-12">
              ...
              <p className="text-green-800 text-base font-semibold">
                Modern, responsive websites built for performance and growth.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 mb-12">
              ...
              <p className="text-blue-800 text-base font-semibold">
                Maximize ROI with data-driven ad campaigns on Google & Meta.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 mb-16 text-right">
              ...
              <p className="text-orange-800 text-base sm:text-lg font-semibold">
                Expand your reach with dedicated freelance marketing support.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 mb-16">
              ...
              <p className="text-yellow-800 text-base font-semibold">
                Account management for Amazon, Flipkart, Meesho & JioMart.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          <div className="max-w-2xl mx-auto text-center space-y-6">
            <div className="relative">
              ...
              <div className="space-y-4">
                <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight">
                  Boost Your Business
                  <span className="block"> With Expert Services</span>
                </h2>

                <p className="text-base md:text-lg text-white/90 max-w-xl mx-auto">
                  From marketing to marketplace management – we’ve got you covered.
                </p>
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-center text-white max-w-lg mx-auto">
                  ...
                  <div className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-green-400" />
                    <span className="text-sm">Marketplace Management</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-white/90">
              <div className="bg-white/20 p-4 rounded-xl backdrop-blur-sm hover:bg-white/30 transition-all duration-300 group">
                ...
                <p className="text-xs">
                  Drive traffic and conversions with proven strategies.
                </p>
              </div>

              <div className="bg-white/20 p-4 rounded-xl backdrop-blur-sm hover:bg-white/30 transition-all duration-300 group">
                <Paintbrush className="w-6 h-6 mb-3 mx-auto group-hover:scale-110 transition-transform" />
                <h3 className="font-semibold mb-1 text-sm">Brand Design</h3>
                <p className="text-xs">
                  Build a unique identity that stands out in your market.
                </p>
              </div>

              <div className="bg-white/20 p-4 rounded-xl backdrop-blur-sm hover:bg-white/30 transition-all duration-300 group">
                <Rocket className="w-6 h-6 mb-3 mx-auto group-hover:scale-110 transition-transform" />
                <h3 className="font-semibold mb-1 text-sm">E-Commerce Growth</h3>
                <p className="text-xs">Scale your store on Amazon, Flipkart & more.</p>
              </div>
            </div>
