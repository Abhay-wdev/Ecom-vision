...
export const metadata = {
  title: "Top E-commerce Listing Service in Jaipur- VIRAL nexus",
  description:
  ...
  robots: "index, follow",
  alternates: {
    canonical: "https://ecomvision.in/ecommerce-listing-service-jaipur",
  },
  openGraph: {
    ...
    url: "https://ecomvision.in/ecommerce-listing-service-jaipur",
    siteName: "VIRAL nexus",
    images: [
      {
        url: "https://ecomvision.in/images/og-ecommerce-listing.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://ecomvision.in/images/og-ecommerce-listing.jpg"],
  },
};
